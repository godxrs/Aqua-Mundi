    ...
    for county in counties:        
        ...
        for specie in species:
            if isMarineLife(specie['attributes']['sciname']):
                print(specie['attributes']['comname'])
            else:
